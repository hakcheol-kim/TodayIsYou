...
class TalkWriteViewController: BaseViewController {
    ...
    internal static func instantiate() ->TalkWriteViewController {
    ...
    @IBAction func onClickedBtnActions(_ sender: UIButton) {
        if sender == btnTalk {
            let vc = PopupListViewController.initWithType(.normal, "선택해주세요.", arrCamTalkMemo, nil) { (vcs, selItem, index) in
