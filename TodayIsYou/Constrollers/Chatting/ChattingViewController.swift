...
//            CNavigationBar.drawRight(self, nil, NSLocalizedString("layout_txt19", comment: "선물"), 2003, #selector(onClickedBtnActions(_:)))
//        }
    ...
    @IBAction func onClickedBtnActions(_ sender: UIButton) {
        if sender.tag == 2000 {
            ...
            let title = "\(toUserName)\(NSLocalizedString("activity_txt180", comment: "님에게 선물하기"))\(strMyPoint)"
                ...
                if giftPoint > myPoint {
                    ...
                    ApiManager.ins.requestSendGiftPoint(param:param) { (res) in
                        ...
                        if isSuccess == "01" {
                            ...
                            let memo = "@@##$$|"+"\(giftPoint)".addComma() + NSLocalizedString("activity_txt249", comment: "별(P)를 선물 했습니다.")
                            self.showToast(msg)
                            param["reg_date"] = Date()
                            param["read_yn"] = true
...
extension ChattingViewController: UITableViewDelegate, UITableViewDataSource {
    ...
    func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        if chat.type == 0 {
            ...
            tmpCell?.configurationData(chat, profile_name:profile_name, toUserName: toUserName)
